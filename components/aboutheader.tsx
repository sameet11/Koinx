  ...
  return (
    <div className="mb-3">
      ...
      <div className="text-base">
        ...
        Blanditiis, dicta quibusdam cupiditate exercitationem incidunt fugit
        minima eaque consectetur officiis cum, deleniti aperiam corrupti labore
        sapiente a amet ab eos. Consequuntur.
      </div>
    </div>
  );
};
